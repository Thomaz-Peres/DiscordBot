...
namespace FirstBotDiscord.Repository
{
    public class MonsterRepository
    {
                    ...
                    while (upando == true)
                    {
                        ...
                        switch (waitAtributeToAsign.Result.Result.Content.ToLower())
                        {
                            case "vitalidade":
                                ...
                                embed.WithDescription(StatusAfterUp(monster));
        ...
        private string StatusAfterUp(BaseMonstersEntity monster)
        {
            return  $"Vitalidade = {monster.MonsterAtributes.Vitalidade.CurrentValuePoints} -- Sorte = {monster.MonsterAtributes.Sorte.CurrentValuePoints}\n" +
